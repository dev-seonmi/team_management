      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="/team/create">팀원 등록</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          <a
            ...
            href="#">공지</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/notice/list">공지 목록</a></li>
            <li><a class="dropdown-item" href="/notice/create">공지 생성</a></li>
          </ul>
        </li>
              <li class="nav-item dropdown">
          <a
